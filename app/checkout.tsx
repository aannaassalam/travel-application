  ...
  return (
    ...
    >
      <View style={[styles.bar, { paddingTop: insets.top + space[2] }]}>
        ...
        <Pressable onPress={() => router.back()} style={styles.close} accessibilityLabel={t("common.close")}>
        ...
        <Reveal index={1}>
          <Surface padded style={{ gap: space[3] }}>
            ...
            <View>
              ...
              >
                <Text variant="base" weight="semibold" tone={zone ? "ink900" : "ink300"}>
                  {zone
