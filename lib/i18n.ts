...
const fr: Record<string, string> = {
  ...
  "auth.pageSub": "Votre numéro est votre compte.",
  ...
  "auth.forgotSub": "Nous envoyons un code à votre numéro. Choisissez ensuite un nouveau mot de passe.",
  "auth.resetCta": "Enregistrer le mot de passe",
  "auth.backToSignIn": "Retour à la connexion",
  "auth.newHere": "Nouveau ici ?",
  "auth.signUpSub": "Un code SMS pour confirmer votre numéro — une seule fois.",
  "auth.stepOf": "Étape {n} sur 2",
  ...
  "auth.accountExists": "Ce numéro a déjà un compte. Connectez-vous avec votre mot de passe.",
  "auth.noAccountYet": "Aucun compte sur ce numéro. Créez-en un — cela prend une minute.",
...
const en: Record<string, string> = {
  ...
  "auth.pageSub": "Your number is your account.",
  "home.eat": "Hungry?",
  "home.seeAll": "See all",
  ...
  "auth.forgotSub": "We\u2019ll send a code to your number. Then choose a new password.",
  "auth.resetCta": "Save new password",
  "auth.backToSignIn": "Back to sign in",
  "auth.newHere": "New here?",
  "auth.signUpSub": "One SMS code to confirm your number \u2014 just once.",
  "auth.stepOf": "Step {n} of 2",
  ...
  "auth.accountExists": "This number already has an account. Sign in with your password.",
  "auth.noAccountYet": "No account on this number yet. Creating one takes a minute.",
